...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('accounts_account_moves', function (Blueprint $table) {
            ...
            $table->double('invoice_currency_rate')->nullable()->comment('Currency Rate');
            $table->double('amount_untaxed')->nullable()->comment('Untaxed Amount');
            $table->double('amount_tax')->nullable()->comment('Tax Amount');
            $table->double('amount_total')->nullable()->comment('Total Amount');
            $table->double('amount_residual')->nullable()->comment('Residual Amount');
            $table->double('amount_untaxed_signed')->nullable()->comment('Untaxed Amount Signed');
            $table->double('amount_untaxed_in_currency_signed')->nullable()->comment('Untaxed Amount in Currency Signed');
            $table->double('amount_tax_signed')->nullable()->comment('Tax Amount Signed');
            $table->double('amount_total_signed')->nullable()->comment('Total Amount Signed');
            $table->double('amount_total_in_currency_signed')->nullable()->comment('Total Amount in Currency Signed');
            $table->double('amount_residual_signed')->nullable()->comment('Residual Amount Signed');
            $table->double('quick_edit_total_amount')->nullable()->comment('Quick Edit Total Amount');
