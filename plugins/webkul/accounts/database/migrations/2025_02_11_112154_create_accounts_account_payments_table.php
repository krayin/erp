...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('accounts_account_payments', function (Blueprint $table) {
            ...
            $table->foreignId('payment_transaction_id')->nullable()->comment('Payment Transaction');
            $table->foreign('payment_transaction_id', 'fk_payment_txn')
                ->references('id')->on('payments_payment_transactions')
                ->nullOnDelete();
            ...
            $table->foreignId('payment_token_id')->nullable()->comment('Payment Token');
            $table->foreign('payment_token_id', 'fk_payment_token')
                ->references('id')->on('payments_payment_tokens')
                ->nullOnDelete();
