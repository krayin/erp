...
enum AccountType: string implements HasLabel
{
    ...
    {
        return [
            self::ASSET_RECEIVABLE->value => __('invoices::enums/account-type.asset-receivable'),
            self::ASSET_CASH->value => __('invoices::enums/account-type.asset-cash'),
            self::ASSET_CURRENT->value => __('invoices::enums/account-type.asset-current'),
            self::ASSET_NON_CURRENT->value => __('invoices::enums/account-type.asset-non-current'),
            self::ASSET_PREPAYMENTS->value => __('invoices::enums/account-type.asset-prepayments'),
            self::ASSET_FIXED->value => __('invoices::enums/account-type.asset-fixed'),
            self::LIABILITY_PAYABLE->value => __('invoices::enums/account-type.liability-payable'),
            self::LIABILITY_CREDIT_CARD->value => __('invoices::enums/account-type.liability-credit-card'),
            self::LIABILITY_CURRENT->value => __('invoices::enums/account-type.liability-current'),
            self::LIABILITY_NON_CURRENT->value => __('invoices::enums/account-type.liability-non-current'),
            self::EQUITY->value => __('invoices::enums/account-type.equity'),
            self::EQUITY_UNAFFECTED->value => __('invoices::enums/account-type.equity-unaffected'),
            self::INCOME->value => __('invoices::enums/account-type.income'),
            self::INCOME_OTHER->value => __('invoices::enums/account-type.income-other'),
            self::EXPENSE->value => __('invoices::enums/account-type.expense'),
            self::EXPENSE_DEPRECIATION->value => __('invoices::enums/account-type.expense-depreciation'),
            self::EXPENSE_DIRECT_COST->value => __('invoices::enums/account-type.expense-direct-cost'),
            self::OFF_BALANCE->value => __('invoices::enums/account-type.off-balance'),
        ];
    }
