...
return new class extends Migration
{
    ...
    {
        Schema::create('invoices_payment_due_terms', function (Blueprint $table) {
            $table->id();
            $table->integer('nb_days')->nullable()->comment('Number of Days');
            $table->foreignId('payment_id')->nullable()->comment('Payment Terms')->constrained('invoices_payment_terms')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('invoices_payment_due_terms');
    }
};
