            ...
            Actions\Action::make('todo')
                ...
                ->action(function (Operation $record) {
                    if (! $record->moves->count()) {
                        Notification::make()
                            ->success()
                            ->title(__('inventories::filament/clusters/operations/resources/internal/pages/edit-internal.header-actions.todo.notification.warning.title'))
                            ->body(__('inventories::filament/clusters/operations/resources/internal/pages/edit-internal.header-actions.todo.notification.warning.body'))
                            ->warning()
                            ->send();
                    ...
                    $record->update(['state' => Enums\OperationState::WAITING]);

                    $record->moves()->update(['state' => Enums\MoveState::CONFIRMED]);

                    Notification::make()
                        ->success()
                        ->title(__('inventories::filament/clusters/operations/resources/internal/pages/edit-internal.header-actions.todo.notification.success.title'))
                        ->body(__('inventories::filament/clusters/operations/resources/internal/pages/edit-internal.header-actions.todo.notification.success.body'))
                        ->success()
                        ->send();
                })
